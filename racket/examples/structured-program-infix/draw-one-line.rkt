...
(function (set-del-element arr x)
  (var ret = ())
  (var i)
  (for ((i = 0) (i < sizeof arr) (i = i + 1))
       (if (x != arr(i))
...
(function (search-graph point graph)
  (var i)
...
(function (get-all-path from_point others_points graph)
  (var ret = ())
  (var i j points t)
...
(function (make-one-point-edges n)
  (var ret1 = ())
  (var ret = (*)(2))
  (ret(0) = n)
  (if (n - 6 >= 0 and n - 6 != 6)
...
(function (is-step-in-path step path)
  (var i)
  (var a = step(0))
  (var b = step(1))
