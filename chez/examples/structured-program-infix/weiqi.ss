...
(define (play-weiqi n black_sub_stones)
  (prog
    (var step_cnt = 0)
...
(define (compare board board_bak step)
  (prog
    (var ret = () (3) 0)
    (var i j)
    (var x = step(0))
...
(define (you-qi-rec board flags n color x y)
  (prog
    (var i x2 y2)
...
(define (clear-stones board color x y)
  (prog
    (var i x2 y2)
    (var n = sizeof board)
    (var dir = ($make-4-directions))
...
(define (run-one-step board step)
  (prog
    (var i)
    (var x = step(0))
    (var y = step(1))
...
(define (judge board black_sub_stones)
  (prog
    (var step)
    (var n = sizeof board)
    (var v)
...
(define (clear-stones-last board x y)
  (prog
    (var i x2 y2)
    (var n = sizeof board)
    (var flags = (()) (n n) #t)
...
(define (clear-stones-last-rec board n flags color x y)
  (prog
    (var i x2 y2)
    (var dir = ($make-4-directions))
    (board(y)(x) = 0)
...
(define (dye-board-rec board n x y)
  (prog
    (var i x2 y2)
    (var ret = 0)
    (var dir = ($make-4-directions))
...
(define (display-weiqi board kill_stones)
  (prog
    (var i j)
    ($printf "\n")
    ($printf "\n")
